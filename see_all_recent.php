...
<body>
    ...
    <?php
    function printAllSkins($conn)
    {
        $query = "SELECT * FROM skin INNER JOIN hero ON skin.h_id = hero.h_id ORDER BY s_id DESC";
        ...
        if ($count > 0) {
            ...
            <div class="skin_container">
                <div class="cap">
                    <h2 style="margin-bottom: 10px; color: white;">All Skins</h2>
                </div>
                            ...
                            <figure class="card-banner">
                                ...
                                <div class="res">
                                    ...
                                    if (isset($skinLogos[$row["s_type"]])) { ?>
                                        <img class="i_img" style="width:80px; height:40px;"
